...
// Icons
import { Cpu, Database, Layout, Server, GitBranch, Palette } from "lucide-react";
    ...
    >
      ...
      >
        {techStack.map((tech, index) => {
          const IconComponent = techIcons[tech] || Cpu;
          return (
            <Grid key={index} size={{ xs: 6, sm: 4, md: 3 }}>
              ...
              >
                <Box
                  ...
                  aria-hidden="true"
                >
                  <IconComponent size={24} color={theme.palette.brand.main} />
                </Box>
                <Typography
                  component="span"
                  sx={{
