...
import {
  matinPersonData,
  matinStructuredData,
} from "@schoolify/features/landing/developers/utilities/matinData";
...
const MatinKhaleghiPage = () => {
  const theme = useAppTheme();
  const data = matinPersonData;
  ...
  useEffect(() => {
    ...
    addStructuredData(matinStructuredData, "matin-person");
  ...
  return (
    <main>
      ...
      <Box
        component="section"
        aria-label="معرفی متین خالقی نژاد"
        sx={{
      ...
      >
        ...
        <Box
          ...
          aria-hidden="true"
        >
          <Code size={50} color={theme.palette.text.white} />
        </Box>
        ...
        <Box sx={{ display: "flex", gap: 2, justifyContent: "center" }}>
          <IconButton
            ...
            aria-label={`ارسال ایمیل به ${data.nameShortPersian}`}
            sx={{
          ...
          <IconButton
            ...
            aria-label={`پروفایل لینکدین ${data.nameShortPersian}`}
            sx={{
              backgroundColor: "rgba(255,255,255,0.15)",
              color: theme.palette.text.white,
              "&:hover": {
      ...
      >
        <Box sx={{ maxWidth: 900, mx: "auto" }}>
          ...
          >
            ...
            مهارت‌ها و تخصص‌های {data.nameShortPersian}
          </Typography>
          ...
          <Grid container spacing={3}>
            <Grid size={{ xs: 12, md: 4 }}>
              ...
              >
                ...
                >
                  <Server size={24} color={theme.palette.brand.main} />
                  <Typography
                    component="h3"
                    sx={{
                      fontWeight: "bold",
            ...
            <Grid size={{ xs: 12, md: 4 }}>
              ...
              >
                ...
                >
                  <Database size={24} color={theme.palette.brand.main} />
                  <Typography
                    component="h3"
                    sx={{
                      fontWeight: "bold",
            ...
            <Grid size={{ xs: 12, md: 4 }}>
              ...
              >
                ...
                >
                  <GitBranch size={24} color={theme.palette.brand.main} />
                  <Typography
                    component="h3"
                    sx={{
                      fontWeight: "bold",
      ...
      >
        ...
        >
          می‌خواهید با {data.nameShortPersian} در ارتباط باشید؟
        </Typography>
...
export default MatinKhaleghiPage;
