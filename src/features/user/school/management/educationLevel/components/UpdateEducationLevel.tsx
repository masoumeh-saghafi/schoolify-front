...
// Validation Schema
import { updateEducationLevelValidationSchema } from '@schoolify/features/user/school/management/educationLevel/validation/updateEducationLevelValidation'

// Form schema
type SchemaProps = z.infer<typeof updateEducationLevelValidationSchema>

// Custom Types
interface UpdateEducationLevelProps {
  recordId: string
  defaultValues: SchemaProps
  onSubmit?: (id: string, updatedFields: any, row: any) => void
}

const UpdateEducationLevel = (props: UpdateEducationLevelProps) => {
  // Props
  ...
  const {
    ...
    defaultValues,
    resolver: zodResolver(updateEducationLevelValidationSchema),
    mode: 'onChange'
  })
