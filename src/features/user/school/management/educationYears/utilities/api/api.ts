...
import eucationYearEndpoints from '@schoolify/features/user/school/management/educationYears/utilities/api/endpoints'
import type ListEucationYearEntity from '@schoolify/features/user/school/management/educationYears/types/api/ListEucationYearEntity'
